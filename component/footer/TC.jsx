...
const TC = ({ onClose }) => {
  ...
  return (
    ...
    <p> These terms and conditions apply to You, the user of this website (including any sub-domains,
        unless expressly excluded by their own terms and conditions), and Vocity Limited, the owner
        and operator of the following website: vocity.ng(the "Website"), with the following URL web
        address: <a href=""> www.vocity.ng</a></p> <br />
    ...
    <p>This Website is comprised of various web pages operated by Vocity Limited.
    ...
    <p><b>a.</b> Assignment: The Owner shall be permitted to assign and transfer its rights and/or obligation
