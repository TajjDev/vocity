...
const Nav = () => {
    ...
    const scrollToHowItWorks = () => {
        const HowItWorks = document.getElementById
            ('HowItWorks');
        if (HowItWorks) {
    ...
    return (
        ...
        {/* <div className='nav'> */}
            ...
            <div id="navs">
                <a style={{color:activeLink === 'home' ? 'rgba(255, 233, 152, 1)' : 'white',textDecoration: activeLink === 'home'  ? 'underline' : 'none',textDecorationThickness: activeLink === 'home' ? '2px' : undefined,textUnderlineOffset: activeLink === 'home' ? '5px' : undefined}} onClick={() => {scrollToHeader();handleLinkClick('home')}} href="#">Home</a>
                ...
                <a style={{color:activeLink === 'howitwork' ? 'rgba(255, 233, 152, 1)' : 'white',textDecoration: activeLink === 'howitwork'  ? 'underline' : 'none',textDecorationThickness: activeLink === 'howitwork' ? '2px' : undefined,textUnderlineOffset: activeLink === 'howitwork' ? '5px' : undefined}} onClick={() => 
                {scrollToHowItWorks();handleLinkClick('howitwork')}} href="#howitwork">How it works</a>
